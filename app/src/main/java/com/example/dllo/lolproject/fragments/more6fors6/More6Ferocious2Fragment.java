 ...
 */
public class More6Ferocious2Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //设置图片
        more6FragmentBackground1.setBackgroundResource(R.mipmap.talent_page_2);
        MoreImageView1.setBackgroundResource(R.mipmap.talent_2_1_11);
        MoreImageView2.setBackgroundResource(R.mipmap.talent_2_1_21);
        MoreImageView3.setBackgroundResource(R.mipmap.talent_2_2_11);
        MoreImageView4.setBackgroundResource(R.mipmap.talent_2_2_21);
        MoreImageView5.setBackgroundResource(R.mipmap.talent_2_2_31);
        MoreImageView6.setBackgroundResource(R.mipmap.talent_2_3_11);
        MoreImageView7.setBackgroundResource(R.mipmap.talent_2_3_21);
        MoreImageView8.setBackgroundResource(R.mipmap.talent_2_4_11);
        MoreImageView9.setBackgroundResource(R.mipmap.talent_2_4_21);
        MoreImageView10.setBackgroundResource(R.mipmap.talent_2_5_11);
        MoreImageView11.setBackgroundResource(R.mipmap.talent_2_5_21);
        MoreImageView12.setBackgroundResource(R.mipmap.talent_2_6_11);
        MoreImageView13.setBackgroundResource(R.mipmap.talent_2_6_21);
        MoreImageView14.setBackgroundResource(R.mipmap.talent_2_6_31);
